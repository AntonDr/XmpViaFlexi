...
namespace VacationsTracker.Droid.Views
{
    ...
    public partial class HomeActivityViewHolder
    {
        ...
        public Android.Support.Design.Widget.NavigationView NavView =>
            navView ?? (navView = activity.FindViewById<Android.Support.Design.Widget.NavigationView>(Resource.Id.nav_view));
    }
    ...
    public partial class NewVacationActivityViewHolder
    {
         private readonly Activity activity;
        ...
        public NewVacationActivityViewHolder( Activity activity)
        {
            if (activity == null) throw new ArgumentNullException(nameof(activity));
